...
Interface Craft includes three installable "skills" — markdown knowledge packs that load into coding agents (Claude Code, Cursor, Windsurf) and activate automatically via relevant keywords.

---

## Overview: Interface Craft Skills
...
## Skill 1 — Storyboard Animation

### Reference page: Using the Storyboard Animation Skill
