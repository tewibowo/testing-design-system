  ...
  return (
    <>
      ...
      <Card surface="raised" className="ex-pa__col" style={{ maxWidth: 520 }}>
        ...
        {step === 1 && (
          <>
            <h2 style={{ font: "var(--title-small)", color: "var(--text-primary)", margin: "0 0 12px" }}>Review</h2>
...
function Row({ label, value, strong = false }) {
  return (
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      <span style={{ font: "var(--body-medium)", color: "var(--text-secondary)" }}>{label}</span>
      <span style={{ font: strong ? "700 16px/1.4 var(--font-display)" : "var(--body-medium)", color: "var(--text-primary)", fontVariantNumeric: "tabular-nums" }}>
        {value}
      </span>
    </div>
  );
