...
function Row({ title, sub, children }) {
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16, padding: "16px 0", borderBottom: "1px solid var(--border)" }}>
      <div style={{ maxWidth: 480 }}>
        <div style={{ font: "700 14px/1.4 var(--font-display)", color: "var(--text-primary)" }}>{title}</div>
        {sub && <div style={{ font: "var(--body-small)", color: "var(--text-secondary)", marginTop: 2 }}>{sub}</div>}
      </div>
