...
const Row = ({ label, meta, font, sample }) => (
  <div style={{ display: "flex", alignItems: "baseline", gap: 18, borderBottom: "1px solid var(--sx-border)", paddingBottom: 10 }}>
  ...
  render: () => (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 24 }}>
      <div>
        ...
        <div style={{ font: "var(--sx-label-medium)", marginTop: 8 }}>Red Hat Display</div>
        <div style={{ font: "var(--sx-body-small)", color: "var(--sx-text-secondary)" }}>Display · Title · Label (Bold)</div>
      ...
      <div>
        ...
        <div style={{ font: "var(--sx-label-medium)", marginTop: 8 }}>Hanken Grotesk</div>
        <div style={{ font: "var(--sx-body-small)", color: "var(--sx-text-secondary)" }}>Body · Headline · Label (Hanken)</div>
      ...
      <div>
        ...
        <div style={{ font: "var(--sx-label-medium)", marginTop: 8 }}>Red Hat Mono</div>
        <div style={{ font: "var(--sx-body-small)", color: "var(--sx-text-secondary)" }}>Numerals · Code · Google Fonts</div>
      </div>
    </div>
  ),
};
...
export const Display = {
  render: () => (
    <div className="tk-row--baseline">
      ...
      <p style={{ font: "var(--sx-body-small)", color: "var(--sx-text-secondary)" }}>Marketing &amp; hero use only. Avoid in dashboard.</p>
    </div>
  ),
};
  ...
  render: () => (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 }}>
      <div>
        ...
        <div style={{ font: "var(--sx-label-large)", color: "#002B2A" }}>Label Large 16</div>
        <div style={{ font: "var(--sx-label-medium)", color: "#002B2A", marginTop: 4 }}>Label Medium 14</div>
        <div style={{ font: "var(--sx-label-small)", color: "#002B2A", marginTop: 4 }}>Label Small 12</div>
      </div>
      <div>
        <div className="tk-meta" style={{ textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 }}>Label · Hanken Grotesk</div>
        <div style={{ font: "var(--sx-body-bold-large)", color: "#002B2A" }}>Label Large 16</div>
        <div style={{ font: "var(--sx-body-bold-medium)", color: "#002B2A", marginTop: 4 }}>Label Medium 14</div>
        <div style={{ font: "var(--sx-body-bold-small)", color: "#002B2A", marginTop: 4 }}>Label Small 12</div>
      </div>
    </div>
  ),
};
...
export const Body = {
  render: () => (
    <div className="tk-row--baseline">
      <div>
        <div style={{ font: "var(--sx-body-large)", color: "#002B2A", maxWidth: 560 }}>
      ...
      <div>
        <div style={{ font: "var(--sx-body-medium)", color: "#002B2A", maxWidth: 560 }}>
      ...
      <div>
        <div style={{ font: "var(--sx-body-small)", color: "#002B2A", maxWidth: 560 }}>
